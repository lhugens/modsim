...
if ((z(k)>-20).and.(z(k)<-2)) then
print*, "cylinder"
print*, "{"
print*, "<",xe(1),",",xe(2),",",xe(3),">, <",xee(1),",",xee(2),",",xee(3),">, 1.2"
print*, "rotate <90,0,0>"
print*, "pigment { color rgb <0.00000, 0.100000, 0.873810>}"
print*, "}"
endif
...
print*, "<",xe(1),",",xe(2),",",xe(3),">, <",xee(1),",",xee(2),",",xee(3),">, 1.2"
print*, "rotate <90,0,0>"
print*, "pigment { color rgb <0.60000, 0.600000, 0.03810>}"
print*, "}"
endif
...
print*, "<",xe(1),",",xe(2),",",xe(3),">, <",xee(1),",",xee(2),",",xee(3),">, 1.2"
print*, "rotate <90,0,0>"
print*, "pigment { color rgb <0.80000, 0.000000, 0.073810>}"
print*, "}"
endif
